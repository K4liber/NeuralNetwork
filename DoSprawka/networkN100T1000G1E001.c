void networkN100T1000G1E001(){
	ifstream ifile;
	ifile.open("networkN100T1000G1E001.txt");
	double val;
	double g=0;
	int pointNumber=0;
	...
	graph->SetTitle("Entropia sieci dla N=100, T=1000, e=0.01, A=3 (g)");
	graph->GetXaxis()->SetTitle("g");
	graph->GetYaxis()->SetTitle("Entropia");

	ifstream ifile2;
	ifile2.open("networkN100T1000G1E001A0.txt");
	double val2;
	double g2=0;
	int pointNumber2=0;
	...
	graph2->SetTitle("Entropia sieci dla N=100, T=1000, e=0.01, A=0 (g)");
